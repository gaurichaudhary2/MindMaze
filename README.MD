...
The system uses a rule-based adaptive engine to adjust the challenge level according to the user's performance. It also provides level unlocking, scoring, category-wise analysis, and assessment history.
